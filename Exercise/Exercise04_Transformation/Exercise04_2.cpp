...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("C:\\Users\\ccyys\\CLionProjects\\LearnOpenGL\\Exercise\\Exercise04_Transformation\\shader04.vs",
                     "C:\\Users\\ccyys\\CLionProjects\\LearnOpenGL\\Exercise\\Exercise04_Transformation\\shader04.fs");
    float vertices[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        transform = glm::translate(transform, glm::vec3(-0.5f, 0.5f, 0.0f));
        float scaleValue = abs(sin((float)glfwGetTime()));
